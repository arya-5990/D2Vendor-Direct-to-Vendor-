...
const PriceTracker = () => (
  <div className="space-y-6">
    <h2 className="text-2xl font-bold mb-6">📊 Price Tracker</h2>
        ...
        <div key={index} className="bg-white rounded-xl shadow-lg p-6">
          ...
          <div className="mb-4">
            ...
            <div className="text-sm text-gray-500">
              Previous: ₹{item.previousPrice}/kg
            </div>
          </div>
          
          {/* Price Chart Placeholder */}
          <div className="mb-4">
            <div className="text-sm text-gray-500 mb-2">Price trends (past 30 days)</div>
            <div className="h-32 bg-gray-50 rounded-lg flex items-center justify-center">
              <div className="text-center">
                ...
                <div className="text-xs text-gray-400">Line chart showing price trends</div>
              </div>
            </div>
          </div>
          
          <div className="flex items-center justify-between text-sm">
            <span className="text-gray-500">30-day average: ₹{Math.round((item.currentPrice + item.previousPrice) / 2)}/kg</span>
    ...
    <div className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-xl p-6 text-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div>
          ...
          <div className="text-sm opacity-90">Items with rising prices</div>
        </div>
        <div>
          <div className="text-2xl font-bold">1</div>
          <div className="text-sm opacity-90">Items cheaper than average</div>
        </div>
        <div>
          <div className="text-2xl font-bold">₹320</div>
          <div className="text-sm opacity-90">Total savings this month</div>
        </div>
      </div>
    </div>
  </div>
